            ...
            <table class="min-w-full text-sm text-left text-gray-600">
                <thead class="bg-gray-100 text-xs uppercase text-gray-500">
                   <tr>
                        ...
                        <th class="px-4 py-3">Salary Name</th>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-3">
                            ...
                            @if ($billHistory->bill_receipt)
                                <a href="{{ asset('storage/receipts/' . $billHistory->bill_receipt) }}" target="_blank" class="text-blue-600 hover:underline">View Receipt</a>
                            @else
                                -
                            @endif
                        </td>
