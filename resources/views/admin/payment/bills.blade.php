<x-admin-layout :title="'Senarai Yuran Pengajian'">
    <!-- Insight -->
    <div class="space-y-6 mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                <div>
                    <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Jumlah Yuran Dibayar</p>
                    <h3 class="text-3xl font-extrabold text-gray-900">RM{{ number_format($totalPaidStudentBill, 2) }}</h3>
                </div>
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                <div>
                    <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Jumlah Yuran Sedang Di Proses</p>
                    <h3 class="text-3xl font-extrabold text-gray-900">RM{{ number_format($totalPendingStudentBill, 2) }}</h3>
                </div>
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                <div>
                    <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Jumlah Yuran Belum Dibayar</p>
                    <h3 class="text-3xl font-extrabold text-gray-900">RM{{ number_format($totalUnpaidStudentBill, 2) }}</h3>
                </div>
        ...
        <div class="bg-white p-4 rounded-xl shadow">
            <div class="flex items-center justify-between mb-4">
                <h3 class="font-semibold">Laporan Tahunan Yuran Pengajian</h3>
     ...
     <script>
        ...
        async function loadSalaryChart(year) {
            ...
            const data = {
                labels: labels,
                datasets: [{
                    label: `Jumlah Yuran Pengajian (RM) untuk ${result.year}`,
                    data: result.data,
                    borderColor: '#16a34a',
    ...
    <div class="bg-white p-6 rounded-xl shadow">
        ...
        <div class="flex items-center justify-between mb-4">
            <div>
                <h2 class="text-lg font-semibold">Senarai Rekod Yuran Pengajian</h2>
                <p class="text-sm text-gray-500">Urus yuran pengajian anda: tambah baru, cari, tapis, sunting, atau padam.</p>
            </div>
            ...
            <table id="billTable" class="w-full min-w-max text-sm text-left text-gray-600">
                <thead class="bg-gray-100 text-xs uppercase text-gray-500">
                    <tr>
                        ...
                        <th class="px-4 py-3">Tarikh Dibuat</th>
                ...
                <tbody id="billBody">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-3">
                            ...
                            @endphp
                            {{ $months[$studentBillRecord->student_bill_month] ?? $studentBillRecord->student_bill_month }}
                        </td>
                        ...
                        <td class="px-4 py-3 flex gap-2 justify-center">
                            <a href="{{ route('admin.bill.report.index', $studentBillRecord->student_bill_id) }}" class="px-3 py-1 text-xs rounded bg-yellow-500 text-white hover:bg-yellow-600">Laporan</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
    ...
    <div id="addStudentBillModal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 items-center justify-center w-full h-full bg-gray-900/50">
        <div class="relative w-full max-w-2xl mx-auto my-8 bg-white rounded-lg shadow-lg">
            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="w-6"></div>
                <h3 class="text-xl font-bold text-gray-800 tracking-wide text-center flex-1">Tambah Yuran Pengajian</h3>
            ...
            <form id="billForm" action="{{ route('admin.bill.store') }}" method="POST">
                ...
                <div class="px-6 py-6 max-h-[70vh] overflow-y-auto">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                        <!-- Month -->
                        <div>
                            <label for="student_bill_month" class="block mb-2 text-sm font-medium text-gray-900">Bulan</label>
                        ...
                        <!-- Year -->
                        <div>
                            <label for="student_bill_year" class="block mb-2 text-sm font-medium text-gray-900">Tahun</label>
                ...
                <div class="flex justify-between px-6 py-4 rounded-b-lg">
                    <button type="button" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm text-center hover:bg-gray-300" data-modal-hide="addStudentBillModal">Batal</button>
