<x-admin-layout :title="'Laporan Yuran Pengajian'">
    ...
    <form action="{{ route('admin.bill.report.update', $id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white p-6 rounded-xl shadow">
            ...
            {{-- maklumat yuran, recordName, year, month --}}
            <div class="mb-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-center p-3 bg-white border border-gray-200 rounded-lg shadow-sm">
                    ...
                    <div>
                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider leading-none mb-1">Nama Rekod</p>
                ...
                <div class="flex items-center p-3 bg-white border border-gray-200 rounded-lg shadow-sm sm:col-span-2 md:col-span-1">
