                ...
                <div class="space-y-6 sm:space-y-10">
                    ...
                    <div>
                        ...
                        <div class="flex items-start gap-3 sm:gap-4">
                            <div>
                                <svg class="shrink-0 size-4 sm:size-5 text-gray-500 dark:text-neutral-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path>
                                    <circle cx="12" cy="10" r="3"></circle>
                                </svg>
                            </div>
                            <div>
                                <p class="text-gray-700 dark:text-gray-300 text-sm sm:text-base">Selangor, Malaysia</p>
                                <address class="mt-1 font-medium text-gray-900 dark:text-white not-italic text-sm sm:text-base">
                    ...
                    <div>
                        ...
                        <div class="space-y-4 sm:space-y-6 flex flex-col sm:flex-row justify-between w-full sm:w-fit gap-6 sm:gap-10">
                            ...
                            <div class="flex items-start gap-3 sm:gap-4">
                                ...
                                <div>
                                    <p class="text-gray-700 dark:text-gray-300 text-sm sm:text-base">Email us</p>
                                    <a href="mailto:hello@example.com" class="font-medium text-gray-900 hover:underline dark:text-emerald-400 text-sm sm:text-base">
                                        assiraaj@gmail.com
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 sm:gap-4">
                                <div>
                                    <svg class="shrink-0 size-4 sm:size-5 text-gray-500 dark:text-neutral-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                                    </svg>
                                </div>
                                <div>
                                    <p class="text-gray-700 dark:text-gray-300 text-sm sm:text-base">Call us</p>
                                    <a href="tel:+60123456789" class="font-medium text-gray-900 hover:underline dark:text-emerald-400 text-sm sm:text-base">
                                        +60 12-345 6789
                                    </a>
                                </div>
                            </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid md:grid-cols-5 gap-8 sm:gap-12">
                ...
                <div class="md:col-span-2 flex justify-center">
                    <div class="max-w-sm">
                        <h2 class="text-2xl sm:text-3xl font-bold md:text-4xl lg:text-5xl md:leading-tight text-gray-800 dark:text-white">
                            Frequently <span class="text-green-600">Asked</span> Questions
                        </h2>
                        <p class="mt-4 text-gray-600 dark:text-neutral-400 text-sm sm:text-base">
                ...
                <div class="md:col-span-3">
                    ...
                    <div id="accordion-collapse" data-accordion="collapse" class="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm">
                        ...
                        <h2 id="accordion-collapse-heading-1">
                            <button type="button" class="flex items-center justify-between w-full p-4 sm:p-5 font-medium text-gray-800 dark:text-gray-200 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition gap-3 text-sm sm:text-base" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
                        ...
                        <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                            <div class="p-4 sm:p-5 bg-gray-50 dark:bg-gray-900">
                        ...
                        <h2 id="accordion-collapse-heading-3">
                            <button type="button" class="flex items-center justify-between w-full p-4 sm:p-5 font-medium text-gray-800 dark:text-gray-200 border-b-0 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition gap-3 text-sm sm:text-base" data-accordion-target="#accordion-collapse-body-3" aria-expanded="false" aria-controls="accordion-collapse-body-3">
