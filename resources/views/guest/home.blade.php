<x-app-layout :title="'Home'">
    <!-- Hero Section -->
    <div class="max-w-full px-4 sm:px-6 md:px-20 pt-4 bg-gray-50">
    ...
    <section class="relative bg-gray-50 px-4 sm:px-6 md:px-20">
        <div class="p-4 sm:p-6 bg-gradient-to-bl from-emerald-700 via-emerald-800 to-emerald-900 rounded-2xl">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-y-8 sm:gap-y-12 gap-x-6 sm:gap-x-10 text-center">
                ...
                <div class="relative text-center flex flex-col items-center">
                    ...
                    <div class="flex justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-12 h-12 sm:w-15 sm:h-15 text-yellow-500 "
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            stroke-width="2">
                ...
                <!-- Stats 2-->
                <div class="relative text-center flex flex-col items-center">
                    <div class="flex justify-center items-center -space-x-6 sm:-space-x-9">
                        <img class="w-8 h-8 sm:w-15 sm:h-15 relative z-2 shrink-0 size-8 rounded-full shadow border-2 sm:border-5 border-emerald-900" src="https://images.unsplash.com/photo-1601935111741-ae98b2b230b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Avatar">
                        <img class="w-8 h-8 sm:w-15 sm:h-15 relative z-1 shrink-0 size-8 rounded-full shadow -mt-4 sm:-mt-7 border-2 sm:border-5 border-emerald-900" src="https://images.unsplash.com/photo-1570654639102-bdd95efeca7a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Avatar">
                        <img class="w-8 h-8 sm:w-15 sm:h-15 relative shrink-0 size-8 rounded-full shadow border-2 sm:border-5 border-emerald-900" src="https://images.unsplash.com/photo-1679412330254-90cb240038c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=320&h=320&q=80" alt="Avatar">
                    </div>
                    <!-- Text -->
                    <div class="mt-3">
                ...
                <div class="relative text-center flex flex-col items-center">
                    <div class="flex justify-center items-center -space-x-4 sm:-space-x-5">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-12 h-12 sm:w-15 sm:h-15 icon icon-tabler icons-tabler-outline icon-tabler-calendar-clock text-yellow-500">
    ...
    <!-- Feedback Section-->
    <section class="relative bg-cover bg-center py-8 sm:py-12 px-4 sm:px-6"
        ...
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6 text-white">
            <h2 class="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-10">
                What Our Users Say
            </h2>

            <div class="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
                <!-- Card 1 -->
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-md p-4 sm:p-6 hover:shadow-lg transition text-gray-800">
