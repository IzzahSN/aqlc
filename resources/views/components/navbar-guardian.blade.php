            ...
            <div class="relative">
                ...
                <button id="profileDropdownButton" data-dropdown-toggle="profileDropdown"
                    ...
                    <div class="hidden sm:block text-left">
                        <h4 class="text-sm font-medium">Fahmi Hazwan</h4>
                    </div>
                ...
                <div id="profileDropdown"
                    ...
                    <div class="px-5 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                        <p class="text-sm font-semibold text-gray-900">Fahmi Hazwan Mohd Nuh</p>
                        <p class="text-xs text-gray-500">fahmihzwn@example.com</p>
                    </div>
