...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-all duration-300 -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
        ...
        <ul class="space-y-2 font-semibold">
            ...
            <!-- Report Management -->
            <li>
                <a href="{{ route('guardian.report.index') }}" class="flex items-center p-2 rounded-lg group {{ request()->routeIs('guardian.report.*') ? 'bg-green-200 text-green-900' : 'text-gray-900 hover:bg-green-100' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition duration-75 {{ request()->routeIs('guardian.report.*') ? 'text-green-900' : 'text-gray-500 group-hover:text-green-900' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <!-- Payment Management -->
            <li>
                <a href="{{ route('guardian.bill.index') }}" class="flex items-center p-2 rounded-lg group {{ request()->routeIs('guardian.bill.*') ? 'bg-green-200 text-green-900' : 'text-gray-900 hover:bg-green-100' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition duration-75 {{ request()->routeIs('guardian.bill.*') ? 'text-green-900' : 'text-gray-500 group-hover:text-green-900' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
