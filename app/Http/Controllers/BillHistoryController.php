...
class BillHistoryController extends Controller
{
    ...
    public function receiptSalary($id)
    {
        $bill = BillHistory::with([
            'tutor',
            'salary'
        ...
        return view('admin.payment.receipt-salary', compact('bill'));
    }

    public function guardianBillReceipt($id)
    {
        $bill = BillHistory::with([
            'student.guardians',
            'studentBill',
        ...
        return view('guardian.receipt', compact('bill'));
    }

    public function tutorSalaryReceipt($id)
    {
        $bill = BillHistory::with([
            'tutor',
            'salary'
        ...
        return view('tutor.receipt-salary', compact('bill'));
    }
}
